                ...
                <Container maxW='2x1'>
                    <GridContainer>
                        ...
                        >
                            ...
                            <BodyContainer>
                                <h1>
                                    Developer collaboration between myself 
                                    <Link style={{color: "green", textDecoration: "none"}} href="https://coffeegremlin.com/"> Tay West </Link>
                                    and 
                                    <Link style={{color: "blue", textDecoration: "none"}} href="https://taywest.dev/"> Nathan, </Link>
                                </h1>
                                <List ml={4} my={4} style={{display: "flex", flexDirection: "column"}}>
                                    ...
                                    <ListItem>
                                        ...
                                        <Link 
                                            href="https://darkdev-collab.netlify.app/"
                                            style={{
                                                color: "#b900ff"
                                            }}
                                        >
                                    ...
                                    <ListItem>
                                        ...
                                        <Link 
                                            href="https://github.com/Darkskittlz/DarkDev-Collab"
                                            style={{
                                                color: "#b900ff"
                                            }}
                                        >
